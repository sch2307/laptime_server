...
--
-- Table structure for table `kesl_raspberry`
--
...
--
-- Dumping data for table `kesl_raspberry`
--

LOCK TABLES `kesl_raspberry` WRITE;
/*!40000 ALTER TABLE `kesl_raspberry` DISABLE KEYS */;
/*!40000 ALTER TABLE `kesl_raspberry` ENABLE KEYS */;
UNLOCK TABLES;
